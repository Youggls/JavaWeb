DELIMITER &&#
drop procedure if exists search_for_floor_by_content;
create procedure search_for_floor_by_content(in key_point varchar(80), out mFloor_id integer, out mFloor_num integer, 
