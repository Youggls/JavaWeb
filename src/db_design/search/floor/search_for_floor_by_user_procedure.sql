...
create procedure search_floor_by_user(in key_point integer, out mFloor_id integer, out mFloor_num integer, 
...
begin
    ...
    #set mUser_id = Ui;
	# set mContent = Ct;
    select floor_id, floor_num, parent_post_id, user_id, floor_content from floor  where user_id = key_point;
end &&$